...
<body>
                    ...
                    <div class="app-sidebar__inner">
                        <ul class="vertical-nav-menu">
                            ...
                            <li class="">
                                ...
                                <ul>
                                    <li>
                                        <a href="{{ route('admin.showDroppers') }}" class="mm-active">
                            ...
                            <li class="app-sidebar__heading">Pickers</li>
                            <li>
                                <a href="#">
                                ...
                                <ul>
                                    <li>
                                        <a href="{{ route('admin.showPickers') }}">
                                            <i class="metismenu-icon">
                                            </i>All Pickers
                                        </a>
                                    </li>
                            ...
                            <li class="app-sidebar__heading">Admin Options</li>
                            <li>
    ...
    <div class="app-drawer-wrapper">
        ...
        <div class="drawer-content-wrapper">
            <div class="scrollbar-container">
                @if (Auth::guard('web')->check())
                <a href="{{ route('admin.logout') }}"><button class="mb-2 mr-2 btn-icon-vertical btn btn-info"><i
                            class="pe-7s-science btn-icon-wrapper"> </i> Logout Admin </button></a>
                @else
                <a href="{{ route('login') }}"><button class="mb-2 mr-2 btn-icon-vertical btn btn-info"><i
                            class="pe-7s-science btn-icon-wrapper"> </i> Login Admin </button></a>
                @endif
